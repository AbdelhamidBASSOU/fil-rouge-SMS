            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a href="<?php echo URLROOT ?>/Admin/addBrand" class="btn btn-info ">Add</a>
                    </div>
                                ...
                                <?php foreach ($data['Brands'] as $brand) { ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo URLROOT ?>/Admin/updateBrand/<?php echo $brand->idBrand; ?>" class="btn btn-primary btn-sm">
                                                    <i class=" fas fa-solid fa-pen"></i>
                                                </a>
                                                <a href="<?php echo URLROOT ?>/Admin/deleteBrand/<?php echo $brand->idBrand; ?>" class="btn btn-danger btn-sm">
