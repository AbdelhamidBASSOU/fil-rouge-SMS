...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" style="size:5px;" href="<?php echo URLROOT ?>/img/image_processing20200412-21268-172ln5q-removebg-preview.png">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="<?php echo URLROOT ?>/Admin/category">Categories</a>
                                    <a class="nav-link" href="<?php echo URLROOT ?>/Admin/brand">Brands</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php echo $data['users'][0]->FullName ?>
                        <div class="row">
