          ...
          <form method="POST" enctype="multipart/form-data">
            <fieldset>
              <div class="form-group">
                ...
                <input type="hidden" value="<?php echo $data['Products']->idProduct; ?>" class="form-control" name="idProduct">
              </div>
              <div class="form-group">
                <label for="Price">Price</label>
                <input type="text" value="<?php echo $data['Products']->Price; ?>" class="form-control" placeholder="Price" name="Price">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" value="<?php echo $data['Products']->Name; ?>" class="form-control" placeholder="enter product name" name="Name">
              </div>
              <select name="idCategory" id="idCategory">
                <option value="">Select Category</option>
                <?php foreach ($data['Categories'] as $Category) { ?>
                  <option value="<?php echo $Category->idCategory; ?>"><?php echo $Category->idCategory; ?></option>
                <?php } ?>
              </select>
              <select name="idBrand" id="idBrand">
                <option value="">Select Brand</option>
                <?php foreach ($data['Brands'] as $Brand) { ?>
                  <option value="<?php echo $Brand->idBrand; ?>"><?php echo $Brand->Name; ?></option>
                <?php } ?>
              </select>

              <div class="form-group">
                <label for="Quantity ">Quantity</label>
                <input type="text" value="<?php echo $data['Products']->Quantity; ?> " class="form-control" placeholder="Quantity" name="Quantity">
              </div>
              <div class="form-group">
