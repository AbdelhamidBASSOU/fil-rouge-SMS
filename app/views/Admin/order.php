                                    ...
                                    <?php foreach ($data['Orders'] as $order) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo URLROOT ?>/Admin/updateOrder/<?php echo $order->idOrder; ?>" class="fa-validate btn btn-info">validate</a>
                                                <?php endif; ?>
                                                <a href="<?php echo URLROOT ?>/Admin/deleteOrder/<?php echo $order->idOrder; ?>" class="fas-trash btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
