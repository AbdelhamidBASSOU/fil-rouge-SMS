            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a href="<?php echo URLROOT ?>/Supplier/addProduct" class="btn btn-info ">Add</a>
                    </div>
                    <div class="card mb-4">
                                ...
                                <?php foreach ($data['Products'] as $product) { ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo URLROOT?>/Supplier/updateProduct/<?php echo $product->idProduct; ?>" class="btn btn-primary btn-sm">
                                                    <i class="fa-solid fa-pen"></i>
                                                </a>
                                                <a href="<?php echo URLROOT?>/Supplier/deleteProduct/<?php echo $product->idProduct; ?>" class="btn btn-danger btn-sm">
