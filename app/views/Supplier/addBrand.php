          ...
          <form method="POST" enctype="multipart/form-data">
            <fieldset>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="idBrand">
            </div>  
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Rate" name="Rating">
              </div>
              <div class="form-group">
                <label for="Sells">Sells</label>
                <input type="text" class="form-control" placeholder="Sells" name="Sells">
              </div>
              <div class="form-group">
                <label for="Buys">Buys</label>
                <input type="text" class="form-control" placeholder="Buys" name="Buys">
              </div>
              <button type="submit" name="addBrand" class="btn-info btn btn-sm mb-2">Add</button>
            </fieldset>
          </form>
        </div>
      </main>
