            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a href="<?php echo URLROOT ?>/Supplier/addBrand" class="btn  bg-info text-white my-3">ADD Brand</a>
                    </div>
                                ...
                                <?php foreach ($data['Brands'] as $brand) { ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $brand->buys; ?></td>
                                            <td>
                                                <a href="<?php echo URLROOT?>/Supplier/updateBrand/<?php echo $brand->idBrand; ?>" class="btn btn-primary btn-sm">
                                                    <i class=" fas fa-solid fa-pen"></i>
                                                </a>
                                                <a href="<?php echo URLROOT?>/Supplier/deleteBrand/<?php echo $brand->idBrand; ?>" class="btn btn-danger btn-sm">
